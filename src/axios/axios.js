...
// export const axiosDoctorInstance = axios.create({
//   baseURL: 'http://13.202.12.178:9090/user/doctor', 
// });

// export const axiosAdminInstance = axios.create({
//   baseURL: 'http://13.202.12.178:9090/user/admin',
// });

// export const axiosAuthInstance = axios.create({
//   baseURL: 'http://13.202.12.178:9090/auth',
// });

// export const axiosUserInstance = axios.create({
//   baseURL: 'http://13.202.12.178:9090/user', 
// });

// export const axiosBookingInstance = axios.create({
//   baseURL: 'http://13.202.12.178:9090/appointment', 
// });
