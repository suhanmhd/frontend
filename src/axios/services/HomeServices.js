...
import {
  ...
  axiosUserInstance,
  axiosAuthInstance,
  axiosBookingInstance,
} from "../axios";
import { toast } from "react-toastify";

// User
export const signIn = (formData) =>
  axiosAuthInstance.post("user/login", formData);
...
export const signUp = (formData) =>
  axiosAuthInstance.post("user/register", formData);
...
export const adminSignIn = (formData) =>
  axiosAuthInstance.post("/admin/login", formData);
...
export const adminSignUp = (formData) =>
  axiosAdminInstance.post("/adminSignup", formData);
...
// Doctor
export const doctorSignIn = (formData) =>
  axiosAuthInstance.post("/doctor/login", formData);
...
export const doctorSignUp = (formData) =>
  axiosAuthInstance.post("/doctor/register", formData);
